...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/ZTo2LZToJJJJ_VBS_Herwig7.py nevts:30'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZTo2LZToJJJJ_VBS_Herwig7.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/VVjj_SemiLeptonic/ZlepZhadJJ_EWK_LO_SM_mjj100_pTj10_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
