...
config.General.requestName = 'WplusToLNuWplusToJJJJ_VBS_Herwig7'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '../configs/WplusToLNuWplusToJJJJ_VBS_Herwig7.py'
config.JobType.allowUndistributedCMSSW = True
config.JobType.numCores = 1
config.JobType.eventsPerLumi = 5000

config.Data.outputPrimaryDataset = 'WplusToLNuWplusToJJJJ_VBS_Herwig7'
